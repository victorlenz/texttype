 		...
 		<div class="container">
    		...
    		<form class="navbar-form navbar-right" role="search">
 						 <div class="forgm-group">
    						...
    						<button type="button" class="btn btn-success navbar-btn" onclick="navigate('home.php')">Sign in</button>
  						</div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-7">
            ...
            <img src="frontends/image/sitemain.png" class="img-responsive">
        ...
        <div class="col-lg-3">
                       ...
                       <h3 class="white-text"> New Here! Sign Up </h3>
                            ...
                            <form class="has-validation-callback" id="registration" method="post" action="functions/main.php">
